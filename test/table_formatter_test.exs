defmodule	TableFormatterTest do
	...
	def split_with_3_columns, do: TF.split_columns(simple_test_data, headers)
	
	test "split_into_columns" do
		columns = split_with_3_columns
	...
	test "column_widths" do
		widths = TF.widths_of(split_with_3_columns)
		assert widths == [5, 6, 7]
	end
	...
	test "Output is correct" do
		result = capture_io fn ->
			TF.print_table_columns(simple_test_data, headers)
		end
